...
export interface GroundOperationsTableProps {
  items: GroundOperations[];
  onEdit: (row: GroundOperations) => void;
  onDelete: (id: string) => void;
}

export function GroundOperationsTable({ items, onEdit, onDelete }: GroundOperationsTableProps) {
  return (
