...
export interface CrewSchedulingTableProps {
  items: CrewScheduling[];
  onEdit: (row: CrewScheduling) => void;
  onDelete: (id: string) => void;
}

export function CrewSchedulingTable({ items, onEdit, onDelete }: CrewSchedulingTableProps) {
  return (
